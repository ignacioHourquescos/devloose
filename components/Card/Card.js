     ...
     ""
      ...
      {displayVideo
            ...
            <div>
               ...
               ?
               <>
                <video  className={ss.video_container_2} loop
       playsinline
       muted
       autoPlay
       controls={true} src={`${project.video}`} ></video>
